...
def best_hand(hand):
    ...
    best_hand_cur = hand[:5]
    for combination in itertools.combinations(hand, 5):
        if hand_rank(combination) > hand_rank(best_hand_cur):
            best_hand_cur = combination
    return best_hand_cur
